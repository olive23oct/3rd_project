...
body .container .half.bg {
  background-image: url("resources/img/oliveTree.png");
         ...
         <div class="content">
            ...
            <div class="signup-cont cont">
               <form action="insertUser.do" method="post" id="joinForm">
                  ...
                  <input type="password" name="passwordchk" id="passwordchk" class="inpt" required="required" placeholder="Password check">
