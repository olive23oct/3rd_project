...
$(document).ready(function(){
 ...
 // 리스트 추가 클릭이벤트
         ...
         console.log("출력되나"+data);
          ...
          $("#listAddWrap").before(
           `<div class="list">
            ...
            <a class="card-archive icon-sm glyphicon 
   ...
   $("#searchUser").click(function(){
              ...
              async: true, 
               ...
               success : function(memberList) {
                  for (let i = 0; i < memberList.length; i++) {  
                      ...
                      "<button id='addMember'>멤버추가</button> "
                      +"</li> "+"</form>"
                       );      
	...
	$("#seachUserId").on("change keyup paste", function(){
  	   if(userId.length != 0) {
	  	  $(".searchResult").show();
	   }else {
	  	  $(".searchResult").hide();
   ...
   $(".open-member").click(function(){
     ...
     var board_index = $(this).children(".member_board_index").val();
      ...
      $(".delete-memeber").append("<form class='deleteMember' action='deleteMember.do'> 보드 탈퇴하기");
      $(".delete-memeber").append("<input type='hidden' value="+member_user_id+" name='user_id' id='user'>");
      
      $(".update-user-id").append("<input type='hidden' value="+member_user_id+" name='user_id'");
      $(".delete-memeber").append("<input type='hidden' value="+board_index+" name='board_index' id='board_index'>");
     
      $(".delete-memeber").append("</form>");
...
<body>
   ...
   <div class="board-header">
      <div class="board-header-menu">
         ...
         <input type="hidden" value="${boardContents[0].content}" id="boardDescription">
               <input id="boardColor" type="hidden" value="${boardContents[0].color}">  
         ...
         <div class="board-hader-profile" style="float: left; color:white">
            <a class="btn btn-default board-team" href="#">Personal</a> 
            |
            <a
         ...
         <div class="board-header-facepile" style="float: left; color:white"> &nbsp;|
             <a class="btn btn-default open-member" href="#MemberModal" data-toggle="modal">
                 <img src="/webapp/upload/${user.image }" id="memberImg">

                 <input type="hidden" value="${user.name }" class="member_name" />
                 <input type="hidden" value="${user.email }"
                 class="member_email" /> <input type="hidden"
                 value="${user.image }" class="member_img" /> <input
                 type="hidden" value="${user.user_id }" class="member_user_id" />
            ...
            <c:forEach var="member" items="${member }" begin="0"
			  ...
			  <c:if test="${user.user_id != member.user_id}">
                  <a class="btn btn-default open-member" href="#MemberModal" data-toggle="modal">
                     <img src="/webapp/upload/${member.image }" id="memberImg">

                     <input type="hidden" value="${member.name }" class="member_name" />
                     <input type="hidden" value="${member.email }"
                     class="member_email" /> <input type="hidden"
                     value="${member.image }" class="member_img" /> <input
         ...
         <div class="member-invite" style="float: left; color:white"> 
            <div class="member" id="Addmember">
               <a class="btn btn-default" id="open-add-member" href="#addMemberModal" data-toggle="modal">멤버를
                  초대해요</a>
            </div>
         </div>
         <div class="board-header-btns" style="float: right">
            <a class="btn btn-default js-board-header-subscribed" href="#"> <span
            ...
            <a class="btn btn-default js-calender" href="#"> <span
               ...
               <a class="btn btn-default js-show-sidebar" href="#"
               id="show-menu"> <span
            ...
            <div id="listWrap" class="listWrap">
               <div class="list">
                  <div class="listTitleWrap">
                     ...
                     <input class="listTitleChangedValue" type="text" name="title"
                           autocomplete="off"> 
                     <span><button class="btn btn-green" id="ListTitleChangeBtn">변경</button></span>   
                           
                           <input type="hidden"
                           name="board_index" value="${list.board_index }">
                     </form>
                  </div>
                        ...
                        <c:if test="${card.card_id != null}">
                           ...
                           <div class="cardWrap">
                              <div class="cardContent">
                                 ...
                                 <input type="hiden" value="${card.card_id}" id="cardId">
                                 <div class="card-menu" style="float: right">
                                    <a id="card-menu"
      ...
      <div class="modal-dialog modal-sm">
         <div class="modal-content">
            ...
            <div class="modal-header" style="height:60px">
               <!-- 닫기(x) 버튼 -->
               <button id="show-menu-close" class="close" data-dismiss="modal" style="float:right">×</button>
               <!-- header title -->
            ...
            <div class="modal-body">
               <div class="show-menu-item">
                  <a class="show-menu-items-aboutBoard" href="#"><span class="icon-sm glyphicon glyphicon-align-left">
                  </span>&nbsp;&nbsp;About This Board
                   <span><h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add a description to your board</h5></span></a>
               </div >
               <div class="show-menu-item">
                  <a class="show-menu-items-change-color" href="#"><span class="icon-sm glyphicon glyphicon-tint">
                  </span>&nbsp;&nbsp;Change Background</a>
               </div>
               <div class="show-menu-item">
                  <a class="show-menu-items" href="#"><span class="icon-sm glyphicon glyphicon-search">
                  </span>&nbsp;&nbsp;Search Cards</a>
               </div>
               <div class="show-menu-item">
                  <a class="show-menu-items" href="#"><span class="icon-sm glyphicon glyphicon-option-horizontal">
                  </span>&nbsp;&nbsp;More</a>
               </div>
               <hr>
               <div class="show-menu-item">
                  <a class="show-menu-items" href="#"><span class="icon-sm glyphicon glyphicon-list">
                  </span>&nbsp;&nbsp;Activity</a>
               </div>
            </div>
           </div>
    ...
    <div id="boardDescriptionModal" >
      <div class="modal-dialog modal-sm">
         <div class="modal-content">
            ...
            <div class="modal-header" style="height:60px">
               <!-- 닫기(x) 버튼 -->
               <button id="about-this-board-close" class="close" data-dismiss="modal" style="float:right">×</button>
               <h4 class="modal-title"><a href="#" class="back-to-show-menu"><span class="glyphicon glyphicon-chevron-left" ></a>
               </span>&nbsp;&nbsp;About This Board</h4>
               <!-- header title -->
            </div>
            <!-- body -->
            <div class="modal-body">
               <div class="userInfoForm">
                   <span class="icon-sm glyphicon glyphicon-user">&nbsp;Made By</span>
                   <br><br>
                   <div class="userInfo" style="inline-block">
                         <div class="userInfoImg" style="float:left; margin-left:10px; margin-right:30px">
               ...
               <form class="boardDescriptionForm" style="display:none">
                    <textarea id="boardContent" rows="" cols="" placeholder="보드 정보 입력"></textarea>
                    <input type="hidden" value="${boardContents[0].board_index }" name="board_index">
                  <button class="btn btn-green" id="boardDescriptionButton">저장하기</button>
                  <span><button id="closeButton" class="close" data-dismiss="modal" style="float:right">×</button></span>
               </form>
   ...
   <div id="boardColorChangeModal">
      <div class="modal-dialog modal-sm">
         <div class="modal-content">
            <div class="modal-header"  style="height:60px">
			   <button id="boardColorModalClose" class="close" data-dismiss="modal" style="float:right">×</button>
               <h4 h4 class="modal-title"><a href="#" class="back-to-show-menu"><span class="glyphicon glyphicon-chevron-left" >Color</h4>
            </div>
            <div class="modal-body">
               <div class="color-list" style="display:block">
                     <input type="hidden" value="${boardContents[0].board_index }" name="board_index">
               <div class="board-background-section" style="background-color: rgb(0, 121, 191);">
               
               </div>
               <div class="board-background-section" style="background-color: rgb(210, 144, 52);">
               </div>
               <div class="board-background-section" style="background-color: rgb(81, 152, 57);">
               </div>
               <div class="board-background-section" style="background-color: rgb(176, 70, 50);">
               </div>
               <div class="board-background-section" style="background-color: rgb(137, 96, 158);">
               </div>
               <div class="board-background-section" style="background-color: rgb(205, 90, 145);">
               </div>
               <div class="board-background-section" style="background-color: rgb(75, 191, 107);">
               </div>
               <div class="board-background-section" style="background-color: rgb(0, 174, 204);">
               </div>
               <div class="board-background-section" style="background-color: rgb(131, 140, 145);">
               </div>
               </div>
            </div>
         </div>
      ...
      <div class="modal-dialog modal-sm">
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <hr>
               <div>
                  <a class="cardMoveToOtherList" href="#">Move All This Cards in This List</a>   
               </div>
               <div>
                  <a class="archiveAllCards" href="#">Archive All Cards in This List</a>
               </div>
               <hr>
               <div>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form class="UserSearch">
                  <input type="text" name="email" id="searchUserId" autocomplete="off">
                  <button class="btn" id="searchUser">찾기</button>
