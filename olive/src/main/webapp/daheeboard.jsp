 ...
 // 리스트 추가 클릭이벤트
   ...
   // show-menu 모달 띄우기
    $("#show-menu").click(function(){
      var showMenuPos = $(this).position();
      var showMenuLeft = showMenuPos.left;
      var shewMenuTop = showMenuPos.top;
      $(".board-menu-content").css({
         "top": shewMenuTop,
         "left": showMenuLeft -180,
         "position": "absolute"
      }).show();
 ...
 //멤버추가 
              ...
              async: true, 
               ...
               success : function(memberList) {
                  ...
                  for (var i = 0; i < memberList.length; i++) {  
                       ...
                       "<button id='addMember'>메일로추가</button> "
                       +"</li> "+"</form>"
                        );      
   ...
   $(".open-member").click(function(){
     ...
     var board_index = $(this).children(".member_board_index").val();
      ...
      $(".delete-memeber").append("<button class='btn' id='delete' >탈퇴</button>");
         ...
         <div class="member-invite" style="float: left">
            <div class="member" id="Addmember">
               ...
               <c:forEach var="member" items="${member }" begin="0"
                  ...
                  <a class="btn open-member" href="#MemberModal" data-toggle="modal">
      ...
      <div class="modal-dialog modal-sm">
         <div class="modal-content">
            <div class="modal-header">
               ...
               <h4 style="text-align: center">{user.user_id}</h4>
            </div>
         ...
         <div class="modal-content">
            ...
            <div class="permission-modal-body">
               ...
               <form class="permission">
                  <a id='update-user-admin' href='#' > 관리자로 변경 </a> <br>
                   <a id='update-user-normal' href='#' > 일반회원으로 변경 </a>
               </form>
